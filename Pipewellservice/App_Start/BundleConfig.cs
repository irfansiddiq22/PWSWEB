...
namespace Pipewellservice
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/supplier/quote").Include(
                "~/Scripts/moment.min.js",
                "~/Scripts/bootstrap-datepicker.min.js",
                "~/Scripts/libraries/daterangepicker/daterangepicker.js",
                "~/Scripts/moment-with-locales.min.js",
                "~/Scripts/ProjectScripts/supplier/SupplierQuote.js"
            ...
            bundles.Add(new Bundle("~/lib/procurement/store/receivingreturn").Include(
                                              "~/Scripts/ProjectScripts/Procurement/Store/OrderReceivingReturn.js"));
            ...
            bundles.Add(new Bundle("~/lib/equipments/quotationcollection").Include(
                                              "~/Scripts/ProjectScripts/Equipments/QuoteCollection.js"));
