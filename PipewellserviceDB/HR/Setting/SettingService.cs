    ...
    public class SettingService : DataServices
    {
        ...
        public async Task<DataTable> UpdateDivision(Division division)
        {
            try
            {
                ...
                collSP[3] = new SqlParameter { ParameterName = "@ParentDivision", Value = division.ParentDivision };
        ...
        public async Task<DataTable> UpdateUser(User user)
        {
            try
            {
                ...
                collSP[5] = new SqlParameter { ParameterName = "@PermissionGroupID", Value = user.PermissionGroupID };
                collSP[6] = new SqlParameter { ParameterName = "@EmailAddress", Value = user.EmailAddress };
